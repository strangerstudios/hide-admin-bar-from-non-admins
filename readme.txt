...
This plugin is just a few lines of code. Specifically the line `if(!current_user_can('administrator'))` determines 
who the admin bar is hidden few. Feel free to edit this to your needs. E.g. using 
